...
namespace Generics {
    public partial class Form1 : Form {
        ...
        private void animalsBtn_Click(object sender, EventArgs e) {
            ...
            petDictionary.Add("Cat", "A furry mammal that eats mice");
            petDictionary.Add("Goldfish", "A fish that eats ants' eggs");
            petDictionary.TryGetValue("Dog", out value);
            textBox1.Text = $"A Dog is {value}\r\n";
